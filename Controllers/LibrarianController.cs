...
namespace Projeto.Controllers
{
    public class LibrarianController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LibrarianId,Name,Address,Mobileno")] Librarian librarian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LibrarianId,Name,Address,Mobileno")] Librarian librarian)
        {
